  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="flex flex-col h-full gap-6 bg-gradient-to-b from-slate-900 to-violet-900/40 p-10">
          <img
        ...
        <div className="flex flex-col h-full gap-6 bg-gradient-to-b from-slate-900 to-violet-900/40 p-8">
          <img
        ...
        <div className="flex flex-col h-full gap-6 bg-gradient-to-b from-slate-900 to-violet-900/40 p-10">
          ...
          <div className="text-slate-400">
            Motion Art for Elementor is designed to be lightweight.Ensure a
            smooth experience for both applicants and administrators.
          </div>
        </div>
      </div>
    </div>
